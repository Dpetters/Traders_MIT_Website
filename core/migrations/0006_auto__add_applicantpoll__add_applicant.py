...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ApplicantPoll'
        db.create_table('core_applicantpoll', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')(default=datetime.date.today)),
        ))
        db.send_create_signal('core', ['ApplicantPoll'])

        # Adding model 'Applicant'
        db.create_table('core_applicant', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('applicantPoll', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.ApplicantPoll'])),
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, blank=True)),
            ('graduation_year', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.GraduationYear'], null=True)),
            ('major', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Course'], null=True)),
            ('website', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('core', ['Applicant'])


    def backwards(self, orm):
        
        # Deleting model 'ApplicantPoll'
        db.delete_table('core_applicantpoll')

        # Deleting model 'Applicant'
        db.delete_table('core_applicant')
    ...
    models = {
        ...
        'core.execmember': {
            ...
            'graduation_year': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.GraduationYear']", 'null': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 20, 16, 49, 15, 26251)'}),
