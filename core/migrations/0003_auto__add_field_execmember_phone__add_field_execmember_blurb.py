...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExecMember.phone'
        db.add_column('core_execmember', 'phone', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True, blank=True), keep_default=False)

        # Adding field 'ExecMember.blurb'
        db.add_column('core_execmember', 'blurb', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ExecMember.phone'
        db.delete_column('core_execmember', 'phone')

        # Deleting field 'ExecMember.blurb'
        db.delete_column('core_execmember', 'blurb')
    ...
    models = {
        ...
        'core.execmember': {
            ...
            'joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 9, 22, 14, 7, 273000)'}),
            'left': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 9, 22, 14, 7, 273000)', 'null': 'True', 'blank': 'True'}),
            'major': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'first_major'", 'null': 'True', 'to': "orm['core.Course']"}),
            'phone': ('django.contrib.localflavor.us.models.PhoneNumberField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'school_year': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.SchoolYear']", 'null': 'True'}),
