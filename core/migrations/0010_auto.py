...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field completed_by on 'ApplicantPoll'
        db.create_table('core_applicantpoll_completed_by', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('applicantpoll', models.ForeignKey(orm['core.applicantpoll'], null=False)),
            ('execmember', models.ForeignKey(orm['core.execmember'], null=False))
        ))
        db.create_unique('core_applicantpoll_completed_by', ['applicantpoll_id', 'execmember_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field completed_by on 'ApplicantPoll'
        db.delete_table('core_applicantpoll_completed_by')
    ...
    models = {
        ...
        'core.execmember': {
            ...
            'graduation_year': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.GraduationYear']", 'null': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 20, 21, 25, 53, 117542)'}),
