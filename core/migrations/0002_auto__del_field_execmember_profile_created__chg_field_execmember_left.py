...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ExecMember.profile_created'
        db.delete_column('core_execmember', 'profile_created')

        # Changing field 'ExecMember.left'
        db.alter_column('core_execmember', 'left', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Adding field 'ExecMember.profile_created'
        db.add_column('core_execmember', 'profile_created', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'ExecMember.left'
        db.alter_column('core_execmember', 'left', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'core.execmember': {
            ...
            'joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 3, 20, 56, 31, 641000)'}),
            'left': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 3, 20, 56, 31, 641000)', 'null': 'True', 'blank': 'True'}),
