...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExecMember.co_president'
        db.add_column('core_execmember', 'co_president', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ExecMember.co_president'
        db.delete_column('core_execmember', 'co_president')
    ...
    models = {
        ...
        'core.execmember': {
            ...
            'joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 9, 10, 51, 26, 36298)'}),
