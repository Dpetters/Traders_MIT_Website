...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Applicant.positives'
        db.add_column('core_applicant', 'positives', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)

        # Adding field 'Applicant.negatives'
        db.add_column('core_applicant', 'negatives', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)

        # Adding field 'Applicant.score'
        db.add_column('core_applicant', 'score', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Applicant.positives'
        db.delete_column('core_applicant', 'positives')

        # Deleting field 'Applicant.negatives'
        db.delete_column('core_applicant', 'negatives')

        # Deleting field 'Applicant.score'
        db.delete_column('core_applicant', 'score')
    ...
    models = {
        ...
        'core.applicant': {
            ...
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            'major': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Course']", 'null': 'True'}),
            'negatives': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'positives': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'score': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '4', 'decimal_places': '3'}),
        ...
        'core.execmember': {
            ...
            'graduation_year': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.GraduationYear']", 'null': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 20, 18, 4, 16, 105301)'}),
