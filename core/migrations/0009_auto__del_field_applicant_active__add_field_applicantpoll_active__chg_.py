...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Applicant.active'
        db.delete_column('core_applicant', 'active')

        # Adding field 'ApplicantPoll.active'
        db.add_column('core_applicantpoll', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Changing field 'ApplicantPoll.date'
        db.alter_column('core_applicantpoll', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))


    def backwards(self, orm):
        
        # Adding field 'Applicant.active'
        db.add_column('core_applicant', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Deleting field 'ApplicantPoll.active'
        db.delete_column('core_applicantpoll', 'active')

        # Changing field 'ApplicantPoll.date'
        db.alter_column('core_applicantpoll', 'date', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        'core.execmember': {
            ...
            'graduation_year': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.GraduationYear']", 'null': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 20, 18, 30, 11, 731695)'}),
